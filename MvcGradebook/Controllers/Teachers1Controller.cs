...
namespace MvcGradebook.Controllers
{
    public class Teachers1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TeacherId,TeacherName,Email")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TeacherId,TeacherName,Email")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
